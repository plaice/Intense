// ****************************************************************************
//
// IntenseTest0.java : A basic sanity test for parsing and copying of Contexts.
//
...
public class IntenseTest0
  ...
  testContext(
    ...
    "<d1:<1.23456789E8>+d2:<1.23456E12+d21:<d211:<-1.23456E-6>+d212:<\"123\">>>>",
    4
  );
  ...
  testContext(
    ...
    "<\"abc 123 _\\U91\\U92\\U0091\\U0092\\U000091\\U000092\\U00000091\\U00000092 def 456\":\"1val\"+2:\"2val\">",
    "<2:<\"2val\">+\"abc 123 _\u0091\u0092\u0091\u0092\u0091\u0092\u0091\u0092 def 456\":<\"1val\">>",
    2
  );
  ...
  {
    IntenseTest0 test = new IntenseTest0();
    test.testMain(argv);
  }
