// ****************************************************************************
//
// IntenseTest5.cpp :  A test for refinement tests.
//
...
IntenseTest* test = new IntenseTest5();


void IntenseTest5::test
()
{
  Context c[20];
  int i;
  int j;
  bool refinementTable1[16][16] = {
  ...
  testParse(9010, c[2], "<a:<-1>>");
  testParse(9020, c[3], "<a:<0>>");
  testParse(9030, c[4], "<a:<1>>");
  testParse(9040, c[5], "<a:<2>>");
  testParse(9050, c[6], "<b:<0>>");
  testParse(9060, c[7], "<a:<1>+b:<2>>");
  testParse(9070, c[8], "<a:<3>>");
  testParse(9080, c[9], "<b:<100000>>");
  testParse(9090, c[10], "<a:<1>+b:<1>+c:<\"one thousand\">>");
  testParse(9100, c[11], "<a:<1>+b:<1>+c:<1000>>");
  testParse(9110, c[12], "<a:<~>>");
  testParse(9120, c[13], "<a:<^>>");
  testParse(9130, c[14], "<a:<1>+b:<~>>");
  testParse(9140, c[15], "<a:<1>+b:<^>>");
  ...
  testParse(12010, c[2], "<\"blah\"+dim1:<a:<-1>>>");
  testParse(12020, c[3], "<\"blah\"+dim1:<a:<0>>>");
  testParse(12030, c[4], "<\"blah\"+dim1:<a:<1>>>");
  testParse(12040, c[5], "<\"blah\"+dim1:<a:<2>>>");
  testParse(12050, c[6], "<\"blah\"+dim1:<b:<0>>>");
  testParse(12060, c[7], "<\"blah\"+dim1:<a:<1>+b:<2>>>");
  testParse(12070, c[8], "<\"blah\"+dim1:<a:<3>>>");
  testParse(12080, c[9], "<\"blah\"+dim1:<b:<100000>>>");
  testParse(12090, c[10], "<\"blah\"+dim1:<a:<1>+b:<1>+c:<\"one thousand\">>>");
  testParse(12100, c[11], "<\"blah\"+dim1:<a:<1>+b:<1>+c:<1000>>>");
  testParse(12110, c[12], "<\"blah\"+dim1:<a:<~>>>");
  testParse(12120, c[13], "<\"blah\"+dim1:<a:<^>>>");
  testParse(12130, c[14], "<\"blah\"+dim1:<a:<1>+b:<~>>>");
  testParse(12140, c[15], "<\"blah\"+dim1:<a:<1>+b:<^>>>");
  ...
  testParse(15010, c[2], "<\"blah\"+dim1:<a:<-1>>+dim2:<a:<-1>>>");
  testParse(15020, c[3], "<\"blah\"+dim1:<a:<0>>+dim2:<a:<0>>>");
  testParse(15030, c[4], "<\"blah\"+dim1:<a:<1>>+dim2:<a:<1>>>");
  testParse(15040, c[5], "<\"blah\"+dim1:<a:<2>>+dim2:<a:<2>>>");
  testParse(15050, c[6], "<\"blah\"+dim1:<b:<0>>+dim2:<b:<0>>>");
  testParse(15060, c[7], "<\"blah\"+dim1:<a:<1>+b:<2>>+dim2:<a:<1>+b:<2>>>");
  testParse(15070, c[8], "<\"blah\"+dim1:<a:<3>>+dim2:<a:<3>>>");
  testParse(15080, c[9], "<\"blah\"+dim1:<b:<100000>>+dim2:<b:<100000>>>");
  testParse(15090, c[10], "<\"blah\"+dim1:<a:<1>+b:<1>+c:<\"one thousand\">>+dim2:<a:<1>+b:<1>+c:<\"one thousand\">>>");
  testParse(15100, c[11], "<\"blah\"+dim1:<a:<1>+b:<1>+c:<1000>>+dim2:<a:<1>+b:<1>+c:<1000>>>");
  testParse(15110, c[12], "<\"blah\"+dim1:<a:<~>>+dim2:<a:<~>>>");
  testParse(15120, c[13], "<\"blah\"+dim1:<a:<^>>+dim2:<a:<^>>>");
  testParse(15130, c[14], "<\"blah\"+dim1:<a:<1>+b:<~>>+dim2:<a:<1>+b:<~>>>");
  testParse(15140, c[15], "<\"blah\"+dim1:<a:<1>+b:<^>>+dim2:<a:<1>+b:<^>>>");
