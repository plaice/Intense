// ****************************************************************************
//
// IntenseTest2.cpp : A basic sanity test for applying ContextOps to Contexts.
//
...
IntenseTest* test = new IntenseTest2();


void IntenseTest2::test
()
{
